...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @DeadPooL_Uploader_Bot\n\n<b>Join : @Dead_DeadPooL</b>"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds.\n\n@DeadPooL_Uploader_Bot"
...
1. Send url (example.domain/file.m3u8 | New Filename).
